...
cli = FlaskGroup(create_app=create_app) #INITIALIZING APP USING FLASK

#               CREATING ARRAY OF DICTIONARIES CONTAINING DETAILS OF USERS
user_json = [
	{
		"name": "John Doe",
...
#               CREATING ARRAY OF DICTIONARIES CONTAINING DETAILS OF PRODUCTS
...
# WRITING FUNCTION TO RECREATE DATABASE	 
def recreate_db():
	db.drop_all()
	db.create_all()
	db.session.commit()
...
# INITIALIZING THE CODE TO EXECUTE
